      ...
      <div className="w-1/2 bg-black flex items-center justify-center text-white">
        <div className="text-center">
          ...
          <form className="flex flex-col items-start">
            <input id="name" type="text" placeholder="Full Name" className="block mb-4 w-64 px-4 py-2 rounded-md placeholder-gray-400" />
            <input id="email" type="text" placeholder="E-mail Address" className="block mb-4 w-64 px-4 py-2 rounded-md placeholder-gray-400" />
            <input id="password" type="password" placeholder="Password" className="block mb-4 w-64 px-4 py-2 rounded-md placeholder-gray-400" />
            <button type="submit" className="bg-blue-500 text-white px-6 py-3 rounded-md self-start">Register</button>
          </form>
        </div>
      </div>
    </div>
